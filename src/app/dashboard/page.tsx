  ...
  return (
    <PullToRefresh onRefresh={fetchDashboard}>
      ...
      <div className="mt-4 sm:mt-6 grid grid-cols-3 gap-3 sm:gap-4">
        {(user?.role === 'vendor'
          ? [
              { href: '/dashboard/post-job', emoji: '📋', label: 'Post a Job',    sub: 'Attract clients' },
              { href: '/dashboard/my-business', emoji: '🏪', label: 'My Business',  sub: 'Update your profile' },
          ...
          : [
              ...
              { href: '/jobs',               emoji: '💼', label: 'Browse Jobs',   sub: 'Find work opportunities' },
              { href: '/dashboard/profile',  emoji: '✏️', label: 'Edit Profile',  sub: 'Update your info' },
            ]
        ).map((a) => (
